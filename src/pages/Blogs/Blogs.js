...
const Blogs = () => {
    return (
        <div className="bg-[#fff5cb]  p-8">
            <h1 className="text-3xl bg-white text-[#175c62] p-8">difference between sql and mysql ?</h1>
            ...
            <h1 className="text-3xl bg-white text-[#175c62] p-8">what is jwt and how does it work?</h1>
            ...
            <h1 className="text-3xl bg-white text-[#175c62] p-8">what is the difference between javascript and nodeJs ?</h1>
            ...
            <h1 className="text-3xl bg-white text-[#175c62] p-8">how does Node Js handle multiple requests at the same time?</h1>
