  ...
  <div className="navbar-end">
    {
        ...
        :<>
            <Link to="/login" className="btn rounded-full bg-[#175c62] hover:bg-white hover:text-[#175c62] text-xl">Login</Link>
            <Link to="/signUp" className="btn rounded-full bg-[#175c62] hover:bg-white hover:text-[#175c62] text-xl">singUp</Link>
        </>
    }
